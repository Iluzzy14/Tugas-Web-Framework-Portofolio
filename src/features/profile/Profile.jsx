...
const Profile = ({ isDarkMode }) => {
  ...
  return (
    <section
      id="profile"
      className="relative w-full py-18 px-6 -mt-6 scroll-mt-20 overflow-hidden transition-colors duration-300"
    >
      {/* Background Decor */}
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-7 space-y-8 order-2 md:order-1 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <h2 className={`text-xl font-bold leading-relaxed max-w-2xl mx-auto md:mx-0 transition-colors duration-300 ${textColor}`}>
              {data.headline}
            </h2>
