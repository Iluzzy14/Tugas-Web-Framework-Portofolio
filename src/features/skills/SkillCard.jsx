const SkillCard = ({ isDarkMode, skills }) => {
  ...
  const cardClass = isDarkMode
    ? "bg-gray-900/50 border-gray-700 hover:border-blue-300"
    : "bg-gray-50 border-gray-200 hover:border-gray-700";
  const iconBgClass = isDarkMode
    ? "bg-gray-500/50 border-gray-700"
